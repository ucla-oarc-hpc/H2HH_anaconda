...
This conda env loacted in the central anaconda installation path can **CANNOT** be modified by users.
...
This command initializes conda but is **NOT NEEDED** to run on Hoffman2
